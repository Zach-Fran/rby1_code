...
#include "rby1_movement/srv/detail/speed_control__rosidl_typesupport_fastrtps_c.h"
...
#include "rby1_movement/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _SpeedControl_Request__ros_msg_type = rby1_movement__srv__SpeedControl_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: speed_input
  {
    cdr << ros_message->speed_input;
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rby1_movement
size_t get_serialized_size_rby1_movement__srv__SpeedControl_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  ...
  // field.name speed_input
  {
    size_t item_size = sizeof(ros_message->speed_input);
...
static uint32_t _SpeedControl_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rby1_movement__srv__SpeedControl_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rby1_movement
size_t max_serialized_size_rby1_movement__srv__SpeedControl_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rby1_movement__srv__SpeedControl_Request;
    is_plain =
      (
      offsetof(DataType, speed_input) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _SpeedControl_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rby1_movement__srv__SpeedControl_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rby1_movement, srv, SpeedControl_Request)() {
...
using _SpeedControl_Response__ros_msg_type = rby1_movement__srv__SpeedControl_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rby1_movement
size_t get_serialized_size_rby1_movement__srv__SpeedControl_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SpeedControl_Response__ros_msg_type * ros_message = static_cast<const _SpeedControl_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_rby1_movement__srv__SpeedControl_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rby1_movement
size_t max_serialized_size_rby1_movement__srv__SpeedControl_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = rby1_movement__srv__SpeedControl_Response;
    is_plain =
      (
...
static size_t _SpeedControl_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rby1_movement__srv__SpeedControl_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rby1_movement, srv, SpeedControl_Response)() {
...
// already included above
// #include "rby1_movement/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "rby1_movement/srv/speed_control.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rby1_movement, srv, SpeedControl)() {
