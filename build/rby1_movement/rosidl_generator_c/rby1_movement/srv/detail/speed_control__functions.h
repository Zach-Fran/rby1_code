...
#ifndef RBY1_MOVEMENT__SRV__DETAIL__SPEED_CONTROL__FUNCTIONS_H_
#define RBY1_MOVEMENT__SRV__DETAIL__SPEED_CONTROL__FUNCTIONS_H_
...
#include "rby1_movement/msg/rosidl_generator_c__visibility_control.h"
 ...
 */
ROSIDL_GENERATOR_C_PUBLIC_rby1_movement
bool
 ...
 * calls
 * rby1_movement__srv__SpeedControl_Request__init().
...
/**
 * It calls
 * rby1_movement__srv__SpeedControl_Request__fini()
 ...
 * rby1_movement__srv__SpeedControl_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * rby1_movement__srv__SpeedControl_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rby1_movement__srv__SpeedControl_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rby1_movement
...
/**
 * It calls
 * rby1_movement__srv__SpeedControl_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_rby1_movement
...
/**
 * It allocates the memory for the array and calls
 * rby1_movement__srv__SpeedControl_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rby1_movement
...
/**
 * It calls
 * rby1_movement__srv__SpeedControl_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // RBY1_MOVEMENT__SRV__DETAIL__SPEED_CONTROL__FUNCTIONS_H_
