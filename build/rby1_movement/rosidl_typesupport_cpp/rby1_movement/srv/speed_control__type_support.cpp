...
static const _SpeedControl_Request_type_support_symbol_names_t _SpeedControl_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rby1_movement, srv, SpeedControl_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rby1_movement, srv, SpeedControl_Request)),
  }
};
...
{
  return &::rby1_movement::srv::rosidl_typesupport_cpp::SpeedControl_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rby1_movement, srv, SpeedControl_Request)() {
  return get_message_type_support_handle<rby1_movement::srv::SpeedControl_Request>();
}
...
static const _SpeedControl_Response_type_support_symbol_names_t _SpeedControl_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rby1_movement, srv, SpeedControl_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rby1_movement, srv, SpeedControl_Response)),
  }
};
...
{
  return &::rby1_movement::srv::rosidl_typesupport_cpp::SpeedControl_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rby1_movement, srv, SpeedControl_Response)() {
  return get_message_type_support_handle<rby1_movement::srv::SpeedControl_Response>();
}
...
static const _SpeedControl_type_support_symbol_names_t _SpeedControl_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rby1_movement, srv, SpeedControl)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rby1_movement, srv, SpeedControl)),
  }
};
...
{
  return &::rby1_movement::srv::rosidl_typesupport_cpp::SpeedControl_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, rby1_movement, srv, SpeedControl)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<rby1_movement::srv::SpeedControl>();
}
